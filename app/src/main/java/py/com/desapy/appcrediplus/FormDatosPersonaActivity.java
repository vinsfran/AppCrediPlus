...
//import py.com.desapy.appbanca.MyApplication;
//import py.com.desapy.appbanca.conf.Configuracion;

public class FormDatosPersonaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_datos_persona);
    ...
    protected void buttonEnviarClicado(View v) throws ParseException {
        ...
        mMaterialDialog.setPositiveButton(R.string.txt_aceptar, new View.OnClickListener() {
         ...
         /*if (etNumeroPin.getText().toString().trim().equals("")) {
           ...
           Intent intent = new Intent(FormDatosPersonaActivity.this, FormDatosPersonaActivity.class);
