...
public class FormIngresoPinActivity extends AppCompatActivity {
    ...
    private TextView tvNumeroCelurar;

    private EditText etNumeroPin;
    private Button btnConfirmar;
    private FloatingActionButton buttonCancelarIntegrante;
    // click listners para los componentes
    private View.OnClickListener buttonConfirmarListener;
    private View.OnClickListener buttonCancelarIntegranteListener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_ingreso_pin);
        ...
        numeroDocumento = getIntent().getExtras().getString("numeroDocumento");
        numeroCelular = getIntent().getExtras().getString("numeroCelular");
    ...
    private void asignaciones() {
        tvNumeroDocumento = (TextView) findViewById(R.id.tv_numero_documento);
        tvNumeroCelurar = (TextView) findViewById(R.id.tv_numero_celular);
        etNumeroPin = (EditText) findViewById(R.id.et_numero_pin);
        ...
        tvNumeroDocumento.setText(numeroDocumento);
        tvNumeroCelurar.setText(numeroCelular);

    }

    private void asignacionListenerButtonEnviar() {
        buttonConfirmarListener = new View.OnClickListener() {
        ...
        btnConfirmar.setOnClickListener(buttonConfirmarListener);
    }
    ...
    protected void buttonEnviarClicado(View v) throws ParseException {
        ...
        if (etNumeroPin.getText().toString().trim().equals("")) {
            mMaterialDialog.setMessage(R.string.txt_mensaje_alerta_campo_nro_pin_vacio);
            mMaterialDialog.show();
        } else {

            Intent intent = new Intent(FormIngresoPinActivity.this, FormDatosPersonaActivity.class);
    ...
    private void ocultarTeclado() {
        ...
        imm.hideSoftInputFromWindow(etNumeroPin.getWindowToken(), 0);
    }
